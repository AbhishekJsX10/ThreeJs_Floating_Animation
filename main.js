    ...
    hoverOverLinks() {
        ...
        links.forEach((link, i) => {
            link.addEventListener("mouseover", () => {
                this.material.uniforms.uTimeline.value = 0.0; // Reset the timeline value
                gsap.to(this.material.uniforms.uTimeline, {
                    value: 5.0, // Ensure this value matches the maximum in your smoothstep in the shader
                    duration: 5, // Increase duration to match the extended transition period
                    onStart: () => {
                        this.uEndIndex = i;
